...
| Balcony__Flux2_Klein_4b_Edit__Key			| (string) - Your *fal.ai* API key that will be used with the *Flux2_Klein_4b_Edit* model. |
...
## Operations
### Generate New Image
Perform a GET request to the *<hostname>/gennew?key=<PrivilegedKey>* endpoint. This will queue a new snapshot to be taken and a new image to be generated.

### Delete an Existing Image
Perform a GET request to the *<hostname>/delete/<ImageId>?key=<PrivilegedKey>* endpoint. *ImageId* is the timestamp of the generated image without any path of extension information, such as *20260101-235959*. This operation will delete both the camera snapshot and the related generated image (if found).

*Note*: I am aware that these should be POST methods and probably use a better authorisation mechanism. However, this is a silly project and practicality is key.
